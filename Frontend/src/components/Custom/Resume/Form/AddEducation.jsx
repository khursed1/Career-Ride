...
const AddEducation = () => {
    ...
    //Below is used for enabling real time preview in preview section
    //whatever we type in form section
            ...
            <div>
                    ...
                    <div key={index}>
                        <div className="grid grid-cols-2 gap-3 border p-3 my-5 rounded-lg">
                            ...
                            <div>
                                ...
                                <Textarea type="text" name="description" onChange={(e) => handleChange(index, e)} />
                            </div>
                        </div>
                ...
                <div className="flex justify-between">
                    ...
                    <Button disabled={loading} onClick={() => onSave()}>
                        {/* Loading effect until the data is saved in the db */}
